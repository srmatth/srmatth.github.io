...
fluidRow(
  column(
    width = 4,
    tags$a(tags$img(src = "resources/portfolio/2021-08-24.jpeg", width = "100%"), href = "portfolio-dataviz.html")
  ),
  column(
    width = 8,
    tags$a(tags$img(src = "resources/portfolio/2021-07-27.jpg", width = "100%"), href = "portfolio-dataviz.html")
  )
)
...
## <a href="portfolio-papers.html">Statistical Papers</a>
